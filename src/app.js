...
Leaflet.marker(WBS, { icon: markerIcon }).addTo(map); // add a marker to the map at the WBS coordinates// add a marker to the map at the WBS coordinates
...
// Set the view to the bounds of all markers اجعل الخريطة تُظهر جميع النقاط تلقائيًا
